...
paperurl: '/files/CNN-Transformer_paper.pdf'
...
<figure>
  <img src="/images/CNN-Transformer_net.png" alt="My figure" style="width:80%">
  <figcaption style="text-align:center; font-size:90%;">Neural Network Architecture</figcaption>
</figure>

<figure>
  <img src="/images/MORO_framework.png" alt="My figure" style="width:80%">
